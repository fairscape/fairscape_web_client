      ...
      const roCrateJson = {
        ...
        "@graph": [
          ...
          },
          {
            "@id": "./",
            "@type": "sc:Dataset",
            name: "Test Dataset Name from LLM",
            "dct:conformsTo": "http://mlcommons.org/croissant/RAI/1.0",
            description:
              "This is a test description generated by the LLM for testing purposes",
            keywords: ["machine learning", "test data", "ai"],
            author: null,
            ...
            "rai:dataCollection":
              "Data was collected through automated surveys and manual entry",
            "rai:dataCollectionType": ["Survey", "Manual Entry"],
            ...
            "rai:personalSensitiveInformation": ["Names", "Email addresses"],
            "rai:dataSocialImpact":
              "This dataset may impact privacy considerations",
            "rai:dataBiases": [],
            "rai:dataLimitations": [
